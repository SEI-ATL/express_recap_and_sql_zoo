...
-- 7.
SELECT name FROM world
WHERE name LIKE '%a%a%a%'     -- not feeling like i completely nailed this one. Will come back to this one to check for a better soution that targets 3 or MORE and not just 3 like I tried.
-- 8.
SELECT name FROM world
 WHERE name LIKE '_t%'
ORDER BY name
...
SELECT name, capital, continent
  FROM world
 WHERE name = capital;          ------ need to figure out how to get only the two columns and not the 3rd.
-- 12.
SELECT name FROM world
...
ORDER BY name
-- 4. This one took a lot of thinking for me.
SELECT name, population
FROM world
...
--- This last one was pretty difficult for me to understand but somehow i managed to get it without fully understanding.
